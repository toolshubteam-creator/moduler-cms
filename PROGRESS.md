...
**Son güncelleme:** Faz-2.1 (Tenant resolver) — DONE
...
| 2.2 | TenantDbContext factory | ⚪ TODO |
...
- **Faz-2.2:** TenantDbContext factory (her tenant icin ayri MySQL connection), Master/Tenant DB ayrimi runtime'da. ITenantContext'ten okur.
